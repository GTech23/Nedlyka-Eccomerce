        ...
        <div className="max-w-3xl w-full bg-white rounded-lg shadow-lg p-8">
          <div className="mb-8 text-center">
            ...
            <p className="text-gray-600 text-lg">
              ...
              Shipping/Return Policy, and Order Tracking information carefully.
            </p>
          </div>
          ...
          <section className="mb-10">
            ...
            <p className="text-gray-600 mb-2">
              At Nedlyka, your privacy is important to us. We collect only the
              information necessary to process your orders and provide you with
              the best shopping experience. Your data is stored securely and
              never shared with third parties except as required to fulfill your
              order or by law.
            </p>
          ...
          <section className="mb-10">
            ...
            <p className="text-gray-600 mb-2">
              By using Nedlyka, you agree to our terms and conditions. These
          ...
          <section className="mb-10">
            ...
            <p className="text-gray-600 mb-2">
              Your use of Nedlyka’s website and services is subject to the
              following terms of use:
            </p>
            <ul className="list-disc pl-6 text-gray-600 space-y-1">
              <li>You may not use our site for any unlawful purpose.</li>
              <li>
                All content on this site is the property of Nedlyka and may not
          ...
          <section className="mb-10">
            ...
            <p className="text-gray-600 mb-2">
              We are committed to delivering your orders quickly and
              efficiently. Please review our shipping and return conditions
              below:
            </p>
            <ul className="list-disc pl-6 text-gray-600 space-y-1">
              <li>
              ...
              <li>
                Express shipping options are available at checkout for faster
                delivery.
              </li>
              <li>
                Returns and exchanges are accepted within 14 days of delivery.
          ...
          <section className="mb-10">
            ...
            <ul className="list-disc pl-6 text-gray-600 space-y-1">
              ...
              <li>
                You can track your order status anytime by logging into your
                Nedlyka account and visiting the "My Orders" section.
              </li>
              <li>
                If you have any issues with tracking or delivery, please contact
          ...
          <div className="text-center text-gray-500 text-sm mt-8">
            ...
            <a
              href="mailto:support@nedlyka.com"
